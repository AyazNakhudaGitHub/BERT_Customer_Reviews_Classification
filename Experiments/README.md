# BERT_Customer_Reviews_Classification/Experiments
A machine learning research project by: Ayaz Nakhuda, David Ferris and Jastejpal Soora 

It is reccomended that if you want to run the final experiments, you will first have to run the notebooks in this (Experiments) directory and save the models to your working directory on Google Drive.
